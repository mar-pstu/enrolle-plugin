...
if ( class_exists( 'pstuTaxonomyTypeOfOffer' ) ) return;


/**
 *	Таксономия ЗНО
 */
class pstuTaxonomyTypeOfOffer {


	protected $name = 'type_of_offer';
	...
	public function create_taxonomy() {
		register_taxonomy(
			...
			array(
				'label'                 => '',
				'labels'                => array(
					'name'                => __( 'Вид предложения',          'pstu-enrollee' ),
					'singular_name'       => __( 'Вид предложения',          'pstu-enrollee' ),
					...
					'menu_name'           => __( 'Вид предложения',          'pstu-enrollee' ),
				),
				'description'           => '',
				'public'                => true,
